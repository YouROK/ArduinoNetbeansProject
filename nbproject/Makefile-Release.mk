...
# Assembler Flags
ASFLAGS=-Os -mmcu=atmega328p -ffunction-sections -fdata-sections -Wl,--gc-sections
...
${OBJECTDIR}/cores/arduino/WInterrupts.o: cores/arduino/WInterrupts.c
	${MKDIR} -p ${OBJECTDIR}/cores/arduino
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DARDUINO=161 -DF_CPU=16000000L -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/arduino/WInterrupts.o cores/arduino/WInterrupts.c
...
${OBJECTDIR}/cores/arduino/hooks.o: cores/arduino/hooks.c
	${MKDIR} -p ${OBJECTDIR}/cores/arduino
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DARDUINO=161 -DF_CPU=16000000L -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/arduino/hooks.o cores/arduino/hooks.c
...
${OBJECTDIR}/cores/arduino/wiring.o: cores/arduino/wiring.c
	${MKDIR} -p ${OBJECTDIR}/cores/arduino
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DARDUINO=161 -DF_CPU=16000000L -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/arduino/wiring.o cores/arduino/wiring.c

${OBJECTDIR}/cores/arduino/wiring_analog.o: cores/arduino/wiring_analog.c
	${MKDIR} -p ${OBJECTDIR}/cores/arduino
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DARDUINO=161 -DF_CPU=16000000L -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/arduino/wiring_analog.o cores/arduino/wiring_analog.c

${OBJECTDIR}/cores/arduino/wiring_digital.o: cores/arduino/wiring_digital.c
	${MKDIR} -p ${OBJECTDIR}/cores/arduino
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DARDUINO=161 -DF_CPU=16000000L -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/arduino/wiring_digital.o cores/arduino/wiring_digital.c

${OBJECTDIR}/cores/arduino/wiring_pulse.o: cores/arduino/wiring_pulse.c
	${MKDIR} -p ${OBJECTDIR}/cores/arduino
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DARDUINO=161 -DF_CPU=16000000L -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/arduino/wiring_pulse.o cores/arduino/wiring_pulse.c

${OBJECTDIR}/cores/arduino/wiring_shift.o: cores/arduino/wiring_shift.c
	${MKDIR} -p ${OBJECTDIR}/cores/arduino
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DARDUINO=161 -DF_CPU=16000000L -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/arduino/wiring_shift.o cores/arduino/wiring_shift.c
